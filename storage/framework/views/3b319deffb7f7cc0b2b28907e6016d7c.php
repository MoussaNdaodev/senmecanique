<?php $__env->startSection('title','Sen Mecanique || HOME PAGE'); ?>
        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item  <?php echo e((($key==0)? 'active' : '')); ?>">
                    ...
                    <div class="carousel-caption d-none d-md-block text-left">
                        ...
                        <a class="btn btn-lg ws-btn wow fadeInUpBig" href="<?php echo e(route('product-grids')); ?>" role="button">Achetez maintenant<i class="far fa-arrow-alt-circle-right"></i></i></a>
                        <a class="btn btn-lg ws-btn wow fadeInUpBig mx-2" href="<?php echo e(route("AssistanceHome")); ?>" role="button">Trouvez en assistance<i class="far fa-arrow-alt-circle-right"></i></i></a>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<section class="small-banner section">
    <div class="container-fluid">
        <div id="categoryCarousel" class="carousel slide" data-ride="carousel" data-interval="3000" data-pause="hover"> <!-- Ajout de data-interval pour le défilement automatique -->
            <div class="carousel-inner">
                <?php
                $category_lists = DB::table('categories')->where('status', 'active')->limit(6)->get(); // Augmenter la limite pour avoir assez d'images
                ?>
                <?php if($category_lists): ?>
                    <?php $__currentLoopData = $category_lists->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!-- Groupes de 3 catégories -->
                                    ...
                                    <?php if($cat->is_parent == 1): ?>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            <div class="single-banner">
                                                <?php if($cat->photo): ?>
                                                    <img src="<?php echo e($cat->photo); ?>" alt="<?php echo e($cat->title); ?>" class="d-block w-100" style="height: 370px; object-fit: cover;">
                                                <?php else: ?>
                                                    <img src="https://via.placeholder.com/600x370" alt="#" class="d-block w-100" style="height: 370px; object-fit: cover;">
                                                <?php endif; ?>
                                                <div class="content">
                                                    <h3 class="text-light"><?php echo e($cat->title); ?></h3>
                                                    <a class="text-light" href="<?php echo e(route('product-cat', $cat->slug)); ?>">Découvrez maintenant</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /End Single Banner  -->
                                    ...
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="<?php echo e(route('product-detail',$product->slug)); ?>">
                                                ...
                                                // dd($photo);
                                                ?>
                                                <img class="default-img" style="width: 350px; height:300px;" src="<?php echo e($photo[0]); ?>" alt="<?php echo e($photo[0]); ?>">
                                                <img class="hover-img" style="width: 350px; height:300px;" src="<?php echo e($photo[0]); ?>" alt="<?php echo e($photo[0]); ?>">
                                                ...
                                                <?php else: ?>
                                                    <span class="price-dec"><?php echo e($product->discount); ?>% de reduction</span>
                                                <?php endif; ?>
                                            ...
                                            <div class="button-head">
                                                <div class="product-action">
                                                    <a data-toggle="modal" data-target="#<?php echo e($product->id); ?>" title="Quick View" href="#"><i class=" ti-eye"></i><span>Achat rapide</span></a>
                                                    <a title="Wishlist" href="<?php echo e(route('add-to-wishlist',$product->slug)); ?>" ><i class=" ti-heart "></i><span>Ajoutez à la liste de souhait</span></a>
                                                </div>
                                                <div class="product-action-2">
                                                    <a title="Add to cart" href="<?php echo e(route('add-to-cart',$product->slug)); ?>">Ajouter au panier</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-content">
                                            ...
                                            <div class="product-price">
                                                <?php
                                                    ...
                                                    $price_CFA =  ($product->price * 586);
                                                    $after_discount_CFA = ($price_CFA-($price_CFA*$product->discount)/100);
                                                ?>
                                                <span>$<?php echo e(number_format($after_discount,2)); ?></span>
                                                <del style="padding-left:4%;">$<?php echo e(number_format($product->price,2)); ?></del>
                                                <br>
                                                <span><?php echo e(number_format($after_discount_CFA)); ?> XOF</span>
                                                <del style="padding-left:4%;"><?php echo e(number_format($price_CFA)); ?> XOF</del>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            <div class="content">
                                ...
                                <a href="<?php echo e(route('product-detail',$data->slug)); ?>">Achetez maintenant</a>
                            </div>
                        </div>
                    </div>
                    <!-- /End Single Banner  -->
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                ...
                                <div class="button-head">
                                    <div class="product-action">
                                        <a data-toggle="modal" data-target="#<?php echo e($product->id); ?>" title="Quick View" href="#"><i class=" ti-eye"></i><span>Achat rapide</span></a>
                                        <a title="Wishlist" href="<?php echo e(route('add-to-wishlist',$product->slug)); ?>" ><i class=" ti-heart "></i><span>Ajouter à la liste de souhait</span></a>
                                    </div>
                                    <div class="product-action-2">
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="list-image overlay">
                                        <?php
                                            ...
                                            // dd($photo);
                                        ?>
                                        <img src="<?php echo e($photo[0]); ?>" alt="<?php echo e($photo[0]); ?>" class="img-fluid w-100 h-100">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount">$<?php echo e(number_format(($product->price-($product->price*$product->discount)/100),2)); ?></p>
                                        <p class="price with-discount"><?php echo e(number_format($after_discount_CFA)); ?> XOF</p>
                                    </div>
                                </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="shop-single-blog">
                            ...
                            <div class="content">
                                ...
                                <a href="<?php echo e(route('blog.detail',$post->slug)); ?>" class="more-btn">Continuez à lire</a>
                            </div>
                        </div>
                        <!-- End Single Blog  -->
                    </div>
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            <div class="quickview-ratting-wrap">
                                                ...
                                                <a href="#"> (<?php echo e($rate_count); ?> Avis client)</a>
                                            </div>
                                            <div class="quickview-stock">
                                                <?php if($product->stock >0): ?>
                                                <span><i class="fa fa-check-circle-o"></i> <?php echo e($product->stock); ?> en stock</span>
                                                <?php else: ?>
                                                <span><i class="fa fa-times-circle-o text-danger"></i> <?php echo e($product->stock); ?> rupture de stock</span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <?php
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mouss\Desktop\PROJET OPERATIONNEL APPLICATION SENMECANIQUE\SenMecanique\resources\views/frontend/index.blade.php ENDPATH**/ ?>