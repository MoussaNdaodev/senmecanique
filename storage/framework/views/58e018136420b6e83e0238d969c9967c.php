...
<?php $__env->startSection('title','SEN MECANIQUE || PRODUCT DETAIL'); ?>
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">Détails de l'achat</a></li>
							</ul>
						</div>
					</div>
				</div>
										...
										<div class="product-des">
											...
											<div class="short">
												...
												<div class="rating-main">
													...
													<a href="#" class="total-review">(<?php echo e($product_detail['getReview']->count()); ?>) Avis</a>
                                                </div>
                                                <?php
                                                    $after_discount=($product_detail->price-(($product_detail->price*$product_detail->discount)/100));
                                                    $price_CFA =  ($product_detail->price * 586);
                                                    $after_discount_CFA = ($price_CFA-($price_CFA*$product_detail->discount)/100);
                                                ?>
												...
												<p class="price"><span class="discount"><?php echo e(number_format($after_discount_CFA)); ?> XOF</span><s>$<?php echo e(number_format($price_CFA)); ?> XOF</s> </p>
											...
											<div class="product-buy">
												...
												<p class="cat">Catégorie :<a href="<?php echo e(route('product-cat',$product_detail->cat_info['slug'])); ?>"><?php echo e($product_detail->cat_info['title']); ?></a></p>
												<?php if($product_detail->sub_cat_info): ?>
												<p class="cat mt-1">Sous Categorie :<a href="<?php echo e(route('product-sub-cat',[$product_detail->cat_info['slug'],$product_detail->sub_cat_info['slug']])); ?>"><?php echo e($product_detail->sub_cat_info['title']); ?></a></p>
												<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
																...
																<p class="text-center p-5">
																	Vous devez <a href="<?php echo e(route('login.form')); ?>" style="color:rgb(54, 54, 204)">vous connecter</a> OU <a style="color:blue" href="<?php echo e(route('register.form')); ?>">vous inscrire</a>
																<!--/ End Form -->
																<?php endif; ?>
																	</div>
																</div>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		<span>Based on <?php echo e($product_detail->getReview->count()); ?> Commentaires</span>
																	</div>
                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                ...
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Ajouter à la liste des souhaits</span></a>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MOUSSA NDAO\Desktop\SenMecanique\resources\views/frontend/pages/product_detail.blade.php ENDPATH**/ ?>