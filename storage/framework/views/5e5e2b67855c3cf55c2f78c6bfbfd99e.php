      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; SEN MECANIQUE <?php echo e(date('Y')); ?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
<?php /**PATH C:\Users\mouss\Desktop\PROJET OPERATIONNEL APPLICATION SENMECANIQUE\SenMecanique\resources\views/backend/layouts/footer.blade.php ENDPATH**/ ?>