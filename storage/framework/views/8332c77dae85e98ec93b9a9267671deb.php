<div id="messages">
    <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <!-- Counter - Messages -->
        <?php if(count(App\Http\Helper::messageList())>5): ?>
            <span data-count="5" class="badge badge-danger badge-counter">5+</span>
        <?php else: ?>

    <span data-count="<?php echo e(count(App\Http\Helper::messageList())); ?>" class="badge badge-danger badge-counter"><?php echo e(count(App\Http\Helper::messageList())); ?></span>
    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
        ...
        <div id="message-items">
            <?php $__currentLoopData = App\Http\Helper::messageList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\MOUSSA NDAO\Desktop\SenMecanique\resources\views/backend/message/message.blade.php ENDPATH**/ ?>