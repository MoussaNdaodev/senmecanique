<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('admin')); ?>">
      ...
      <div class="sidebar-brand-text mx-3">SEN MECANIQUE</div>
    </a>
...
<?php /**PATH C:\Users\MOUSSA NDAO\Desktop\SenMecanique\resources\views/backend/layouts/sidebar.blade.php ENDPATH**/ ?>