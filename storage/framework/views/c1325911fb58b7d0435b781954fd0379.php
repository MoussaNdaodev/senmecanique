					...
					<table class="table shopping-summery">
						...
						<tbody id="cart_item_list">
							<form action="<?php echo e(route('cart.update')); ?>" method="POST">
								<?php echo csrf_field(); ?>
								<?php if(\App\Http\Helper::getAllProductFromCart()): ?>
									<?php $__currentLoopData = \App\Http\Helper::getAllProductFromCart(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											<?php
									...
									<track>
										...
										<td class="float-right">
											<button class="btn float-right" type="submit">Mettre a jour</button>
										</td>
									</track>
								<?php else: ?>
										<tr>
											<td class="text-center">
												Il n'y a aucun panier disponible. <a href="<?php echo e(route('product-grids')); ?>" style="color:blue;">Continuer vos achats</a>
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="<?php echo e(\App\Http\Helper::totalCartPrice()); ?>">Sous-total du panier<span>$<?php echo e(number_format(\App\Http\Helper::totalCartPrice(),2)); ?></span></li>

										<?php if(session()->has('coupon')): ?>
										<li class="coupon_price" data-price="<?php echo e(Session::get('coupon')['value']); ?>">Vous économisez<span>$<?php echo e(number_format(Session::get('coupon')['value'],2)); ?></span></li>
										<?php endif; ?>
										<?php
										...
										?>
										<?php if(session()->has('coupon')): ?>
											<li class="last" id="order_total_price">Vous payez<span>$<?php echo e(number_format($total_amount,2)); ?></span></li>
										<?php else: ?>
											<li class="last" id="order_total_price">Vous payez<span>$<?php echo e(number_format($total_amount,2)); ?></span></li>
										<?php endif; ?>
									</ul>
									<div class="button5">
										<a href="<?php echo e(route('checkout')); ?>" class="btn">Paiement</a>
										<a href="<?php echo e(route('product-grids')); ?>" class="btn">Continuez vos achats</a>
									</div>
								</div>
							</div>
						</div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MOUSSA NDAO\Desktop\SenMecanique\resources\views/frontend/pages/cart.blade.php ENDPATH**/ ?>