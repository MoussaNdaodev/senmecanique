<?php $__env->startSection('title','Sen Mecanique || Blog Page'); ?>
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Barre latérale</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <img src="<?php echo e($post->photo); ?>" alt="<?php echo e($post->photo); ?>">
                                    <div class="content">
                                        ...
                                        <a href="<?php echo e(route('blog.detail',$post->slug)); ?>" class="more-btn">Continuez a Lire</a>
                                    </div>
                                </div>
                                <!-- End Single Blog  -->
                            </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            <h3 class="title">Categories du Blog</h3>
                            ...
                            <form action="<?php echo e(route('blog.filter')); ?>" method="POST">
                                    ...
                                    <?php $__currentLoopData = \App\Http\Helper::postCategoryList('posts'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                        ...
                        <div class="single-widget side-tags">
                            ...
                            <ul class="tag">
                                ...
                                <form action="<?php echo e(route('blog.filter')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php $__currentLoopData = \App\Http\Helper::postTagList('posts'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <li>
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Abonnez-vous et recevez les dernières nouvelles <br> et mises à jour.</h4>
                                <form method="POST" action="<?php echo e(route('subscribe')); ?>" class="form-inner">
                                    <?php echo csrf_field(); ?>
                                    <input type="email" name="email" placeholder="Enter your email">
                                    <button type="submit" class="btn " style="width: 100%">Envoyez</button>
                                </form>
                            </div>
                        </div>
                        <!--/ End Single Widget -->
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mouss\Desktop\SenMecanique\resources\views/frontend/pages/blog.blade.php ENDPATH**/ ?>