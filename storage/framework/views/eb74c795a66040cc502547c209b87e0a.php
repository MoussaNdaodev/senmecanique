<?php $__env->startSection('title','Sen Mecanique || PRODUCT PAGE'); ?>
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">Liste de courses</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
                                ...
                                <div class="single-widget recent-post">
                                    <h3 class="title">Publication récente</h3>
                                    ...
                                    <?php $__currentLoopData = $recent_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="price"><del class="text-muted"><?php echo e(number_format($price_CFA)); ?> XOF</del>   $<?php echo e(number_format($after_discount_CFA)); ?> XOF </p>
                                            </div>
                                        </div>
                                        <!-- End Single Post -->
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										...
										<div class="shop-shorter">
											...
											<div class="single-shorter">
												...
												<select class='sortBy' name='sortBy' onchange="this.form.submit();">
													...
													<option value="category" <?php if(!empty($_GET['sortBy']) && $_GET['sortBy']=='category'): ?> selected <?php endif; ?>>Categorie</option>
											...
											<div class="row">
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	...
																	<a title="Wishlist" href="<?php echo e(route('add-to-wishlist',$product->slug)); ?>" class="wishlist" data-id="<?php echo e($product->id); ?>"><i class=" ti-heart "></i><span>Ajoutez à la liste de souhait</span></a>
																</div>
																<div class="product-action-2">
																	<a title="Add to cart" href="<?php echo e(route('add-to-cart',$product->slug)); ?>">Ajoutez au panier</a>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														...
														<a href="javascript:void(0)" class="btn cart" data-id="<?php echo e($product->id); ?>">Achetez Maintenant!</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="quickview-content">
												...
												<form action="<?php echo e(route('single-add-to-cart')); ?>" method="POST">
													...
													<div class="add-to-cart">
														<button type="submit" class="btn">Ajoutez au panier</button>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MOUSSA NDAO\Desktop\SenMecanique\resources\views/frontend/pages/product-lists.blade.php ENDPATH**/ ?>