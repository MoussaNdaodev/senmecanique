                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                ...
                                <p>Veuillez vous inscrire pour effectuer votre paiement plus rapidement</p>
                                <!-- Form -->
                                <div class="row">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            <label>Numéro de telephone<span>*</span></label>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="order-details">
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
                                            ...
                                            <li class="shipping">
                                                Shipping Cost
                                                <?php if(count(\App\Http\Helper::shipping())>0 && \App\Http\Helper::cartCount()>0): ?>
                                                    <select name="shipping" class="nice-select">
                                                        <option value="">Sélectionnez votre adresse</option>
                                                        <?php $__currentLoopData = \App\Http\Helper::shipping(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipping): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li class="coupon_price" data-price="<?php echo e(session('coupon')['value']); ?>">Vous économisez<span>$<?php echo e(number_format(session('coupon')['value'],2)); ?></span></li>
                                            <?php endif; ?>
                                            <?php
                                ...
                                <div class="single-widget payement">
                                    <div class="content">
                                        <img src="<?php echo e(asset('frontend/img/logo_paypal/paypal.png')); ?>" alt="#">
                                    </div>
                                </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MOUSSA NDAO\Desktop\SenMecanique\resources\views/frontend/pages/checkout.blade.php ENDPATH**/ ?>